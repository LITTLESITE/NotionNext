...
const BLOG = {
  AUTHOR: 'QAQ', // 作者
  BIO: ':-)干饭!', // 作者简介
  LINK: 'https://next.littlesite.ml', // 网站地址
  KEYWORDS: '博客,littlesite', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '本页使用国外域名,未备案', // 备案号 闽ICP备XXXXXXX
  ...
  CONTACT_EMAIL: 'tx@littlesite.ml',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: '',
  CONTACT_TELEGRAM: '',
  ...
  COMMENT_VALINE_APP_ID: process.env.NEXT_PUBLIC_VALINE_ID || 'HoQv4PJbzwW5fCUmycfGx4WI-MdYXbMMI', // Valine @see https://valine.js.org/quickstart.html 或 https://github.com/stonehank/react-valine#%E8%8E%B7%E5%8F%96app-id-%E5%92%8C-app-key
  COMMENT_VALINE_APP_KEY: process.env.NEXT_PUBLIC_VALINE_KEY || 'HuMo2AEnWn7POukm0TOjWGNA',
  COMMENT_VALINE_SERVER_URLS: process.env.NEXT_PUBLIC_VALINE_SERVER_URLS || '', // 该配置适用于国内自定义域名用户, 海外版本会自动检测(无需手动填写) @see https://valine.js.org/configuration.html#serverURLs
  COMMENT_VALINE_PLACEHOLDER: process.env.NEXT_PUBLIC_VALINE_PLACEHOLDER || '整两句呗~', // 可以搭配后台管理评论 https://github.com/DesertsP/Valine-Admin  便于查看评论，以及邮件通知，垃圾评论过滤等功能

  COMMENT_WALINE_SERVER_URL: process.env.NEXT_PUBLIC_WALINE_SERVER_URL || 'littlesitepl.vercel.app', // Waline 评论 @see https://waline.js.org/guide/get-started.html
